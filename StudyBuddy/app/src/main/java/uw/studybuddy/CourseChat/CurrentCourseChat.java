...
public class CurrentCourseChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_course_chat);
        ...
        mDatabaseChat = FirebaseDatabase.getInstance().getReference().child("CourseChat").child(eventname);//.child(mCurrentUser.getDisplayName()).child(eventname);
