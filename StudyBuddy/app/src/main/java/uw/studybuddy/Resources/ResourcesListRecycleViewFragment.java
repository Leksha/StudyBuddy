 ...
 * {@link ResourcesListRecycleViewFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ResourcesListRecycleViewFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ResourcesListRecycleViewFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<ResourceInfo, ResourceCardViewHolder> fbRecyclerAdapter;
    private Query mQueryCourse;

    public ResourcesListRecycleViewFragment() {
     ...
     * @return A new instance of fragment ResourcesListRecycleViewFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ResourcesListRecycleViewFragment newInstance(String param1, String param2) {
        ResourcesListRecycleViewFragment fragment = new ResourcesListRecycleViewFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mQueryCourse = FirebaseResourceInfo.getFilteredQuery();
        fbRecyclerAdapter = new FirebaseRecyclerAdapter<ResourceInfo, ResourceCardViewHolder>(
                ResourceInfo.class,
                R.layout.cardview_resourceinfo,
                ResourceCardViewHolder.class,
                mQueryCourse
        ) {
            @Override
